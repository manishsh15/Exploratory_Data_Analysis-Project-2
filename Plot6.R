Exploratory Data Analysis-Project2-Q6
...
# Compare emissions from motor vehicle sources in Baltimore City with emissions from motor vehicle sources in Los Anageles County,
